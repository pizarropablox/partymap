 ...
 * Proporciona endpoints para operaciones CRUD de eventos y funcionalidades adicionales.
 */
@RestController
@CrossOrigin
...
public class EventoController {
    ...
    public ResponseEntity<EventoResponseDTO> createEventoConUbicacion(
        ...
        try {
            Evento evento = convertToEntity(eventoDTO);
            Ubicacion ubicacion = convertUbicacionToEntity(ubicacionDTO);
    ...
    private Evento convertToEntity(EventoDTO dto) {
        ...
        // TODO: Buscar y asignar ubicacion y productor por ID
